 ...
 * Unlike the previous version, each item now navigates straight to a real
 * (read-only, sample-data) page under /demo, so a visitor can actually see
 * how the feature works. Any Save/Preview/Print button on those pages is
 * what triggers the "create a free account" prompt — browsing is free.
 */
